  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-screen bg-gray-100">
      ...
      <main className="flex-1 p-6 mt-16 lg:mt-0 sm:w-[90%]">
        ...
        >
          {[
            { img: "https://randomuser.me/api/portraits/men/32.jpg", name: "Ali Khan", role: "CEO, TechSolutions", review: "Mahab did an amazing job developing our website. Her attention to detail and modern design skills are top-notch!" },
            { img: "https://randomuser.me/api/portraits/women/44.jpg", name: "Ayesha Noor", role: "Founder, CreativeDesign", review: "Highly professional and skilled! The UI/UX design Mahab created for my project exceeded my expectations." },
            { img: "https://randomuser.me/api/portraits/men/56.jpg", name: "Ahmed Raza", role: "E-commerce Owner", review: "Mahab's expertise in Next.js and TailwindCSS helped us launch a seamless online store. Highly recommended!" },
          ].map((client, index) => (
            <motion.div
              key={index}
              initial={{ opacity: 0, y: 50 }}
              ...
              className="p-6 bg-white shadow-lg rounded-lg flex flex-col items-center text-center"
            >
              <img src={client.img} alt="Client" className="w-16 h-16 rounded-full mb-3" />
