    ...
    <div className="flex flex-col md:flex-row bg-gray-100 p-6 md:p-12">
      ...
      <div className="w-full md:w-1/2 bg-white p-6 shadow-lg rounded-lg">
        ...
        <form className="space-y-4">
          <input type="text" placeholder="Your Full Name (Required)" className="w-full p-2 border border-gray-300 rounded" required />
          <input type="email" placeholder="Your Email (Required)" className="w-full p-2 border border-gray-300 rounded" required />
          <input type="text" placeholder="Subject" className="w-full p-2 border border-gray-300 rounded" />
          <textarea placeholder="Your Message" className="w-full p-2 border border-gray-300 rounded h-32" />
